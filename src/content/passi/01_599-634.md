...
italiano:
  ...
  - "{600}di questi corpi primi che non può"
  ...
  - "{605}s'aggiungono con ordine in gran numero"
  ...
  - "{610}le loro parti minime si aggregano"
  ...
  - "{615}se non ci fosse questa parte minima"
  ...
  - "{620}Non sarà più possibile distinguerli."
  ...
  - "{625}l'esistenza di corpi elementari"
  ...
  - "{630}con queste non sarebbe più capace"
