...
temi: ["atomi: movimento", "sensi", "infinito"]
traduttore: "Antonio Vigilante"
fonteLatino: "Cyril Bailey"
bozza: false
ultimaRevisione: "2026-07-20"
latino:
...
note:
 - n: 1
   lingua: "it"
   testo: >
     Gli agnellini <em>coruscant</em>: si muovono in modo vivace, ma al tempo stesso dolce (<em>blande</em>). Giocano tra di loro. Il verbo però può indicare anche il <em>risplendere</em>, con una sfumatura significativa, dato il contesto (anticipa il fulgore finale), che non è tuttavia facile mantenere nella traduzione. 
 - n: 2
   lingua: "it"
   testo: >
